...
import { TrendingUp, LayoutDashboard, LogOut } from "lucide-react";
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="w-64 border-r bg-card flex flex-col overflow-y-auto">
        ...
        {/* Role Header */}
        <div className="px-4 py-3 border-b bg-gradient-to-br from-chart-4/10 to-chart-4/5">
          <h3 className="text-sm font-bold font-poppins text-foreground">Reviewer Portal</h3>
          <p className="text-xs text-muted-foreground">Committee Review</p>
        </div>

        {/* Navigation Menu */}
        <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
          {reviewerModules.map((module) => {
