...
function ProjectCard({
  ...
  return (
    ...
    >
      {/* Top: transaction ID + review badge */}
      <div className="flex items-start justify-between gap-2">
        <span className="font-mono text-xs text-muted-foreground truncate">
          {project.transaction_id}
        </span>
        <Badge className={`${getReviewStatusColor(project.review_status)} flex-shrink-0 text-xs`} variant="outline">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <span className="text-xs text-muted-foreground">{project.name_of_collection}</span>
...
export default function CheckerDFUR() {
  ...
  const handleFlag = () => {
    ...
    if (!flagComment.trim()) {
      toast({ variant: "destructive", title: "Comment Required", description: "Please provide a comment explaining why this project is being flagged." });
      return;
    }
      ...
      <div className="p-4 md:p-8 space-y-4 md:space-y-6">
        ...
        <div className="grid gap-3 md:gap-6 grid-cols-1 sm:grid-cols-3">
          ...
          <Card className="bg-gradient-to-br from-yellow-500/5 to-yellow-500/10 shadow-lg">
            ...
            <CardContent>
              <p className="text-3xl md:text-4xl font-bold text-foreground" data-testid="text-pending-projects">
          ...
          <Card className="bg-gradient-to-br from-red-500/5 to-red-500/10 shadow-lg">
            ...
            <CardContent>
              <p className="text-3xl md:text-4xl font-bold text-foreground" data-testid="text-flagged-projects">
        ...
        <Card className="shadow-lg">
          <CardHeader className="pb-3">
            <CardTitle className="font-poppins text-base md:text-lg">DFUR Projects Review</CardTitle>
          </CardHeader>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-mono font-medium">{viewProject.transaction_id}</p>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-semibold text-lg">{formatCurrency(viewProject.total_cost_approved)}</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Total Cost Incurred</p>
                    <p className="font-semibold text-lg">{formatCurrency(viewProject.total_cost_incurred)}</p>
                  </div>
                </div>
        ...
        <Dialog
          ...
          onOpenChange={(open) => {
            if (!open) { setSelectedProject(null); setFlagComment(""); }
          }}
        >
          <DialogContent className="w-[calc(100%-2rem)] max-w-[500px] mx-auto rounded-lg">
            <DialogHeader>
              <DialogTitle className="font-poppins">Flag Project for Review</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
              {selectedProject && (
                <div className="bg-muted p-4 rounded-md">
                  ...
                  <p className="font-mono text-sm">{selectedProject.transaction_id}</p>
                </div>
              )}
              <div>
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-2 justify-end">
                <Button
                  variant="outline"
                  onClick={() => { setSelectedProject(null); setFlagComment(""); }}
