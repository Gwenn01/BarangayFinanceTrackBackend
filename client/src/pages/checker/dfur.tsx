  ...
  const handleFlag = () => {
    ...
    if (!flagComment.trim()) {
      toast({
        ...
        description: "Please provide a comment explaining why this project is being flagged.",
      });
      return;
    }
    ...
    <CheckerLayout>
      <div className="p-8 space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Review and flag DFUR projects for compliance</p>
        </div>
