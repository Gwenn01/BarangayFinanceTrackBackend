...
export default function ReviewerDFUR() {
  ...
  const totalApprovedCost = projects?.reduce((sum, p) => sum + parseFloat(p.totalCostApproved as any), 0) || 0;
  const totalIncurredCost = projects?.reduce((sum, p) => sum + parseFloat(p.totalCostIncurred as any), 0) || 0;
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="bg-gradient-to-br from-blue-500/5 to-blue-500/10 shadow-lg">
            <CardHeader>
              <CardTitle className="font-poppins text-base">Total Approved Cost</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-gradient-to-br from-purple-500/5 to-purple-500/10 shadow-lg">
            <CardHeader>
              <CardTitle className="font-poppins text-base">Total Incurred Cost</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-3xl font-bold text-foreground" data-testid="text-total-incurred">
                      ...
                      projects.map((project) => (
                        <TableRow key={project.id} data-testid={`row-dfur-${project.id}`}>
                          ...
                          <TableCell className="text-sm">
                            {format(new Date(project.transactionDate), 'MMM dd, yyyy')}
                          </TableCell>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Badge className={getReviewStatusColor(viewProject.reviewStatus)} variant="outline">
                      {viewProject.reviewStatus === "pending" ? "Pending" : 
                       viewProject.reviewStatus === "approved" ? "Approved" : "Flagged"}
                    </Badge>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
