...
import { insertRevenueSchema, type Revenue, type InsertRevenue } from "../../../shared/schema";
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground font-poppins">Revenue Tracking</h1>
          <p className="text-muted-foreground mt-1">Monitor and manage barangay revenue sources</p>
        </div>
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              <DialogTitle className="font-poppins">Add New Revenue</DialogTitle>
            </DialogHeader>
            <Form {...form}>
              <form onSubmit={form.handleSubmit((data) => createRevenue.mutate(data))} className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Enter revenue source" {...field} data-testid="input-source" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="OR/AR Number" {...field} value={field.value || ""} data-testid="input-reference" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Additional details" {...field} value={field.value || ""} data-testid="input-description" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <div className="flex gap-2 justify-end pt-4">
                  ...
                  <Button type="submit" disabled={createRevenue.isPending} data-testid="button-submit">
      ...
      <Card className="bg-gradient-to-br from-chart-1/5 to-chart-1/10 border-card-border shadow-lg">
        ...
        <CardContent>
          <p className="text-4xl font-bold text-foreground" data-testid="text-total-revenue-collected">
