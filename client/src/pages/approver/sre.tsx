...
export default function ApproverSRE() {
  ...
  const CollectionCard = ({ collection }: { collection: Collection }) => (
    <div
      className={`rounded-lg border p-4 space-y-3 ${
        collection.is_flagged === true ? "bg-red-500/20 border-red-500" : ""
      }`}
    ...
    >
      ...
      <div className="flex gap-2 pt-1">
        ...
        <Button
          ...
          onClick={() =>
            openFlagDialog(collection.id, "collection", collection.transaction_id)
          }
        ...
        <Button
          ...
          onClick={() =>
            handleReviewClick(collection, "collection", "approved")
          }
  ...
  const DisbursementCard = ({
    ...
    <div
      className={`rounded-lg border p-4 space-y-3 ${
        disbursement.is_flagged === true ? "bg-red-500/20 border-red-500" : ""
      }`}
    ...
    >
      ...
      <div className="flex gap-2 pt-1">
        ...
        <Button
          ...
          className="flex-1 text-green-600 border-green-300 hover:bg-green-50 touch-manipulation"
          onClick={() =>
            handleReviewClick(disbursement, "disbursement", "approved")
          }
  ...
  return (
    <ApproverLayout>
                  ...
                  <>
                    ...
                    <div className="flex flex-col gap-3 sm:hidden">
                      ...
                      <Pagination
                        ...
                        totalPages={disbursementsTotalPages}
      ...
      <Dialog open={reviewDialogOpen} onOpenChange={setReviewDialogOpen}>
        <DialogContent
          className="w-[calc(100vw-2rem)] max-w-md rounded-lg"
